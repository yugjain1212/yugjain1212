...
ROWS = [
    ...
    ("kv", "Now", "B.Tech AI & CS Student @ JK Lakshmipat University"),
    ("kv", "Focus", "Backend Engineering, AI/ML & Cloud"),
    ("kv", "Building", "CrawlIQ • AI-Powered SEO Intelligence Platform"),
    ("kv", "Learning", "Distributed Systems, LLMs & System Design"),
    ("kv", "Edu", "B.Tech CS (AI), JKLU '28"),

    ("gap",),

    ("sec", "Stack"),

    ("kv", "Languages", "Go, Python, C, TypeScript, SQL"),
    ("kv", "Backend", "Gin, Fiber, FastAPI, Flask"),
    ("kv", "AI / ML", "scikit-learn, LangChain, OpenAI"),
    ("kv", "Database", "PostgreSQL, MySQL, MongoDB, SQLite"),
    ("kv", "Cloud", "Docker, Git, Linux, AWS"),

    ("gap",),

    ("sec", "Highlights"),

    ("bul", "Building CrawlIQ — AI SEO & Sitemap Analysis Platform"),
    ("bul", "Backend • AI/ML • Open Source Enthusiast"),
    ("bul", "Interested in High-Performance Go Systems"),
]
...
parts.append(f'<text x="{W/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
             f'text-anchor="middle">yugjain1212@github: ~$ neofetch</text>')
...
for i, row in enumerate(ROWS):
    ...
    if kind == "host":
        inner = (f'<text x="{KEY_X}" y="{y:.1f}" font-size="14" font-weight="700">'
                 f'<tspan fill="{GREEN}">yugjain1212</tspan><tspan fill="{MUTED}">@</tspan>'
